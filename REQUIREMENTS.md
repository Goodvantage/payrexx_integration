...
- **Versioning.** App version tracks the Frappe major (`16.1.1` in `payrexx_integration/__init__.py`, `pyproject.toml` dynamic version), per the bench custom-app versioning policy.
